// app/connect/page.tsx (Server Component version — with hardcoded example URLs)
// Drop this file into your Next.js app router project (./app/connect/page.tsx)
// TailwindCSS assumed.


export default function ConnectPage() {
// Replace these with your real env vars in production (set in Vercel → Settings → Environment Variables)
...
<a
href={SP_URL}
className="inline-flex w-full sm:w-auto items-center justify-center rounded-xl px-5 py-3 text-sm font-semibold shadow-sm transition bg-emerald-600 hover:bg-emerald-700 text-white"
>
