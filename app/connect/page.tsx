      ...
      <div className="w-full max-w-lg rounded-2xl bg-white p-8 shadow">
        ...
        {!adsOk || !spOk ? (
          <p className="mt-4 text-sm text-gray-500">
            After you click <em>Allow</em> at Amazon, you’ll return here. The connected item turns green; then connect the other one.
            Once both are connected you’ll be taken to your dashboard.
          </p>
        ) : null}
      </div>
    </div>
