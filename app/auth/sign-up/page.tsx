...
setOk(true)
setTimeout(()=>{ window.location.href = "/auth/sign-in" }, 900)
}
...
<button className="w-full rounded-md bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3 transition">Sign Up</button>
{ok && <p className="text-sm text-emerald-700">Saved! Redirecting…</p>}
</form>


<p className="mt-6 text-center text-sm text-gray-600">
Already have an account? <Link href="/auth/sign-in" className="text-emerald-700 font-medium">Log In</Link>
</p>
</div>
</main>
)
